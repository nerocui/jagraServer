    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invitations", x => new { x.UserId, x.OrganizationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DependerId = table.Column<int>(nullable: false),
                    DependeeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDependencies", x => new { x.DependeeId, x.DependerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskWatches", x => new { x.UserId, x.TaskId });
                    table.ForeignKey(
                        name: "FK_TaskWatches_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskWatches_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentReplies", x => new { x.ReplyId, x.ReplyToId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReplies_ReplyToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDependencies_DependerId",
